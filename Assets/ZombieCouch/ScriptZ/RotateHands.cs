...
public class RotateHands : MonoBehaviour {
	...
	void Update()
	{
		...
		if (Quaternion.Angle(lftHand.transform.rotation, Quaternion.Euler(0f, -105f, 270f)) >= 3f)// Quaternion.Euler(0f, 0f, 30f))
		{
		...
		if (Quaternion.Angle(ritHand.transform.rotation, Quaternion.Euler(0f, 105f, 90f)) >= 3f)// Quaternion.Euler(0f, 0f, 30f))
		{
